...
export default function Home() {
  ...
  const mint = async () => {
    ...
    const payload = {
      ...
      function:
        "0xc071ef709539f7f9372f16050bf984fe6f11850594b8394f11bc74d22f48836b::candy_machine_v2::mint_tokens",
      type_arguments: [],
  ...
  useEffect(() => {
    setCanMint(
      wallet.connected &&
        candyMachineData.data.isPublic &&
        parseInt(candyMachineData.data.numUploadedTokens) > parseInt(candyMachineData.data.numMintedTokens) &&
          ...
          >
            {isFetchignCmData ? (
              ...
              <>
                ...
                <span className={`${styles.defaultInput} me-3`}>1</span>
                  <button
